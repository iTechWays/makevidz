...
function getAnnouncements() {
    ...
    if ($query->num_rows > 0)
    {
        ...
        return \SocialKit\UI::view('announcements/content', 'announcements_ui_editor');
    }
}
...
function getStoryPostBox($timelineId=0, $recipientId=0, $placeholder='') /* Publisher, Wall Owner */
{
    ...
    {
        $themeData['privacy_selector'] = \SocialKit\UI::view('story/publisher-box/privacy-selector');
    }

    /* Wrappers */
    $themeData['textarea_wrapper'] = \SocialKit\UI::view('story/publisher-box/wrappers/textarea');
    $themeData['photos_wrapper'] = \SocialKit\UI::view('story/publisher-box/wrappers/photos');
    $themeData['googlemaps_wrapper'] = \SocialKit\UI::view('story/publisher-box/wrappers/googlemaps');
    $themeData['emoticons_wrapper'] = \SocialKit\UI::view('story/publisher-box/wrappers/emoticons');
    $themeData['all_wrappers'] = \SocialKit\UI::view('story/publisher-box/wrappers/all');
    $themeData['all_wrappers'] .= \SocialKit\Addons::invoke(array('new_story_feature_option', 'string'));
    ...
    $themeData['emoticons_launcher_icon'] = \SocialKit\UI::view('story/publisher-box/launcher-icons/emoticons');
    $themeData['all_launcher_icons'] = \SocialKit\UI::view('story/publisher-box/launcher-icons/all');
    $themeData['all_launcher_icons'] .= \SocialKit\Addons::invoke(array('new_story_feature_launchericon', 'string'));
    
    if ($continue == true)
    {
        return \SocialKit\UI::view('story/publisher-box/content', 'story_publisher_ui_editor');
    }
}
...
function getFollowSuggestions($searchQuery='', $limit=5, $type='all')
{
    ...
    return \SocialKit\UI::view('suggestions/follow-suggestions-content', 'suggestions_ui_editor');
}
...
function getTrendings($type='latest', $limit=5)
{
    ...
    if ($query->num_rows > 0)
    {
        ...
        return \SocialKit\UI::view('trendings/content', 'trendings_ui_editor');
    }
}
