<?php
function youtube_search_display_video ($conn, $story)
{
	...
	if ($query->num_rows == 1)
	{
		...
		if (! empty($fetch['youtube_video_id']))
		{
			return '<div class="youtube-wrapper" align="center">
			    <iframe src="https://www.youtube.com/embed/' . $fetch['youtube_video_id'] . '?ap=%2526fmt%3D18&disablekb=1&rel=0" width="100%" height="300px" frameborder="0" allowfullscreen></iframe>
			</div>';
		}
	}
}
