...
class Story {
	...
	public function getRows()
	{
		...
		if ($query1->num_rows == 1)
		{
	        ...
	        // Invoke addons
	        $this->data = \SocialKit\Addons::invoke(array('story_content_editor', 'array'), $this->data);
	...
	public function getCommentBox($timelineId=0)
	{
	    ...
	    return \SocialKit\UI::view('comment/publisher-box/content', 'comment_publisher_ui_editor');
	}
	...
	public function getTemplate() {
        ...
        $mediaHtml = \SocialKit\Addons::invoke(array('story_display_addon_data', 'string'), $this->conn, $this->data);
        ...
        $this->template = \SocialKit\UI::view('story/content', 'story_content_ui_editor', $this->conn, $this->data);
	...
	public function getReactionActivityTemplate()
	{
		...
		foreach ($this->getTopReactions() as $k => $v)
		{
			...
			$themeData['list_reactions'] .= \SocialKit\UI::view('story/list-reaction-activity-each');
		}

        return \SocialKit\UI::view('story/reaction-activity') . $vvv;
	}
