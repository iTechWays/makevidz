    ...
    public function register()
    {
        ...
        if ($this->continue)
        {
            ...
            if ($query)
            {
                ...
                {
                    \SocialKit\Addons::invoke(array('new_story_insert_data', 'no_return'), $this->getConnection(), $this->storyId, $this->addonData);
                }

                if ( !is_null($this->addonFile) )
                {
                    \SocialKit\Addons::invoke(array('new_story_insert_datafile', 'no_return'), $this->getConnection(), $this->storyId, $this->addonFile);
                }
